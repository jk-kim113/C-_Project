...
namespace Server_CardBattle
{
    ...
    class MainServer
    {
        ...
        //                            DefinedStructure.Packet_MyInfo pConnect = new DefinedStructure.Packet_MyInfo();
        //                            pConnect = (DefinedStructure.Packet_MyInfo)ConvertPacket.ByteArrayToStructure(packet_fromClient._data, pConnect.GetType(), packet_fromClient._totalSize);

        //                            DefinedStructure.Packet_CompleteJoin pCheckConnect;
        //                            //pCheckConnect._UUID = GetUUIDFromDB(pConnect._name);
        //                            pCheckConnect._UUID = fPacket._UUID;
        //                            pCheckConnect._index = -999;
